...
#%%
sns.distplot(cars_omit_data['price'])
plt.scatter(cars_omit_data['price'],cars_omit_data['Age'])
sns.distplot(cars_omit_data['powerPS'])
sns.boxplot(y=cars_omit_data['price'])
sns.boxplot(cars_omit_data['Age'])
sns.regplot(y=cars_omit_data['price'],x=cars_omit_data['Age'],scatter=True,fit_reg=False)
sns.regplot(y='price',x='powerPS',data=cars_omit_data,scatter=True,fit_reg=False)
cars_data['seller'].value_counts()
sns.countplot('seller',data=cars_data)
sns.countplot('abtest',data=cars_data)
