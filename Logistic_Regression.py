...
""" Points to note:missing = data[data.isnull().any(axis=1)]
...
# marital status
Marital  = sns.countplot(y=data2['maritalstatus'],hue = 'SalStat', data=data2)
Marrital_salstat = pd.crosstab(index = data2["maritalstatus"], columns =data2['SalStat'],margins = True,normalize = 'index')  
round(Marrital_salstat*100,1)

# 'relationship'
sns.countplot(y='relationship',hue='SalStat',data=data2)
pd.crosstab(index=data2['relationship'],columns=data2['SalStat'],margins = True,normalize = 'index')

# race
sns.countplot(y='race',hue='SalStat',data=data2)
pd.crosstab(index=data2['race'],columns=data2['SalStat'],margins = True,normalize = 'index')
...
# Confusion matrix
confusion_matrix = confusion_matrix(test_y2, prediction2)
print(confusion_matrix)
